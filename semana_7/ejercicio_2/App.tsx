...
// Fallback en memoria si se ejecuta en Web (donde C++/MMKV no existe)
class WebMMKVFallback {
...
const MMKVConstructor: any =
  typeof MMKVImport === "function" ? MMKVImport : WebMMKVFallback;
export const storage = new MMKVConstructor({ id: "ejercicio-02" });
...
export default function App(): React.JSX.Element {
  ...
  useEffect(() => {
    ...
    addLog(
      `MMKV leído — theme: ${theme}, pageSize: ${pageSize}, darkMode: ${darkMode}`,
    );
  }, []);
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={[styles.card, { backgroundColor: card }]}>
          ...
          <Text style={[styles.hint, { color: fg }]}>
            Valores leídos e impresos en el log al montar el componente.
          </Text>
        ...
        <View style={[styles.card, { backgroundColor: card }]}>
          ...
          <Pressable
            style={[styles.btn, isBenchRunning && styles.btnDisabled]}
